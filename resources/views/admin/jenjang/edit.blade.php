...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Jenjang <a href="{{url('jenjang')}}" class="btn btn-info btn-xs"><i class="fa fa-chevron-left"></i> Back </a></h1>
...
<div class="card-body">
    ...
    {!! Form::model($jenjang, ['method' => 'PATCH','route' => ['jenjang.update', $jenjang->id]]) !!}
      ...
      <div class="form-group{{ $errors->has('namaJenjang') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text"  id="namaJenjang" name="namaJenjang" class="form-control col-md-7 col-xs-12" value="{{$jenjang->namaJenjang}}" >
      ...
      <div class="form-group{{ $errors->has('ket') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text"  id="ket" name="ket" class="form-control col-md-7 col-xs-12" value="{{$jenjang->ket}}" >
            @if ($errors->has('ket'))
