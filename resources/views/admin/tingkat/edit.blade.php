...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit Tingkatan <a href="{{url('tingkat')}}" class="btn btn-info btn-xs"><i class="fa fa-chevron-left"></i> Back </a></h1>
...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">Edit Data Tingkat</h3>
      
  </div>


<div class="card-body">
    <!-- <form method="patch" action="" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data"> -->
    {!! Form::model($tingkat, ['method' => 'PATCH','route' => ['tingkat.update', $tingkat->id]]) !!}
    ...
    <div class="form-group{{ $errors->has('namaJenjang') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text"  id="nama" name="nama" class="form-control col-md-7 col-xs-12" value="{{$tingkat->nama}}" >
            @if ($errors->has('nama'))
      ...
      <div class="form-group{{ $errors->has('jenjang') ? ' has-error' : '' }}">
        ...
        <select class="form-control" id="jenjang" name="jenjang">
            <option value="{{$tingkat->id}}">{{$tingkat->jenjang->namaJenjang}}</option>
                                        @if(count($jenjang))
