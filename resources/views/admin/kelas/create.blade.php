...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Create kelas <a href="{{url('kelas')}}" class="btn btn-info btn-xs"><i class="fa fa-chevron-left"></i> Back </a></h1>
...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">Create Data kelas</h3>
      
  </div>


<div class="card-body">
    <form method="post" action="{{ route('kelas.store') }}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
    ...
    <div class="form-group{{ $errors->has('waliKelas') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text" class="form-control" id="waliKelas" name='waliKelas' placeholder="Isikan Wali Kelas" require>
    ...
    <div class="form-group{{ $errors->has('desk') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text" class="form-control" id="desk" name='desk' placeholder="Isikan Deskripsi" require>
                @if ($errors->has('desk'))
