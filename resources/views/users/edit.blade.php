...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Edit New User <a href="{{url('users')}}" class="btn btn-info btn-xs"><i class="fa fa-chevron-left"></i> Back </a></h1>
...
<div class="card-body">
    <!-- <form method="patch" action="{{ route('users.update',$user->id) }}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data"> -->
    {!! Form::model($user, ['method' => 'PATCH','route' => ['users.update', $user->id]]) !!}
      ...
      <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text"  id="name" name="name" class="form-control col-md-7 col-xs-12" value="{{$user->name}}" required >
      ...
      <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text"  id="username" name="username" class="form-control col-md-7 col-xs-12" value="{{$user->username}}" required >
      ...
      <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text"  id="email" name="email" class="form-control col-md-7 col-xs-12" value="{{$user->email}}" required >
            @if ($errors->has('email'))
      ...
      <div class="col-12 col-sm-6">
        <div class="form-group">
            <strong>Role:</strong>
            <div class="select2-purple">
              {!! Form::select('roles[]', $roles,$userRole, array('class' => 'select2 form-control','multiple','select2-purple')) !!}
            </div>
        </div>
    </div>
